...
const sound_die = [
    ...
    [,,327,.07,.06,.23,3,.6,,-3,-10,.25,,,,.4,,.51,.03]
];
...
const sound_explosion = [
    ...
    [1.1,,83,.08,.08,.53,4,3.1,,-9,,,.08,1.1,,.2,,.44,.09,.1],
    [1.1,,91,.03,.23,.5,4,2.6,8,,,,,.2,,.5,,.46,.14]
];
const sound_checkpoint = [
    [.6,0,500,,.04,.3,1,2,,,570,.02,.02,,,,.04],
    [1,.05,99,.09,.11,.07,0,1.5,0,-27,-159,.01,.06,0,0,0,0,.97,.5,0,0],
    [,,344,.01,.01,.08,1,2.8,,108,,,,,,,,.62,.04],
    [1.9,,235,.05,.28,.24,,2.4,,,-64,.07,,,,,,.54,.11,,287],
    [,,362,,,.14,,1.8,,40,497,.1,,,,,,.89,.07,.16],
    [,,362,,,.14,,1.9,,40,497,.1,-0.02,,,,,.89,.07,.16],
    [.8,,551,.01,.07,.19,,2.6,,18,413,.09,,.2,,,,.68,.02,,346],
    [1.2,,522,.02,.04,.01,2,.9,-2,,3,.17,,,,,.18,.86,.02,,-843]
];
